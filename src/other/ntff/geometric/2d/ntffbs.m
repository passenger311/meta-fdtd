...
% The function ntffbs computes the differential scattering cross section of an object hit by a plane wave for a strongly forward scattering object.
%
% The input is:
...
% dft1%s_%i.set with %s element of {'+x','-x','+y','-y'}
%                   %i all numbers covered by freqnumber
% dft2%s_%i.set with %s element of {'+x','-x','+y','-y'}
%                   %i all numbers covered by freqnumber
% ../dft-ref1_%i.set with %i same as above
% ../dft-ref2_%i.set with %i same as above
%
