...
E       =   p_par(5);               % Free space photon energy (eV)
         ...
         % Call silver.m to calculate permittivity


d_layers    =   [1000].*1e-9;             % Thickness of layers (1:N) (m)


% Build structure parameter arrays

eps_struc   =   [1 4 1];       % Structure permittivity array
