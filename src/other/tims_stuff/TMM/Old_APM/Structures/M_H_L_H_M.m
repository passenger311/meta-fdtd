...
epsh    =   4;
epsl    =   1;
epsp    =   lossy_drude_K(omega);


d_layers    =   [3 300 3].*1e-9;             % Thickness of layers (1:N) (m)


% Build structure parameter arrays

eps_struc   =   [epsp 4 1 4 epsp];                % Structure permittivity array
