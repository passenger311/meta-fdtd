...
d_layers    =   [60 40 60 40 60].*1e-9;             % Thickness of layers (1:N) (m)


% Build structure parameter arrays

eps_struc   =   [1 1.62^2 epss 1.62^2 epss 1.62^2 1];       % Structure permittivity array
