...
wp          =   1.39e16;
gamma       =   4.9974e12;
eps_ag      =   drude(eps_inf,wp,gamma,omega);
air         =   1;
Si          =   3.47^2;
SiO2        =   1.44^2;

d_layers    =   [100 180 200]*1e-9;             % Thickness of layers (1:N) (m)


% Build structure parameter arrays

eps_struc   =   [air eps_ag SiO2 Si SiO2];                % Structure permittivity array
