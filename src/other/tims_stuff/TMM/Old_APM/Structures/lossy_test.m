...
d_layers    =   [1.707e-3,8.083e-2,6.877e-4,5.096e-3,3.104e-4].*lambdap;             % Thickness of layers (1:N) (m)


% Build structure parameter arrays

eps_struc   =   [5 2 5 2 5 1 epsp];                % Structure permittivity array
mu_struc    =   [1 1 1 1 1 1 1];                      % Structure permeabillity array
