...
function par = Freddie_opt_ITO(p_par)
...
d_layers    =   [70 60 21 27].*1e-9;             % Thickness of layers (1:N) (m)


% Build structure parameter arrays

eps_struc   =   [418 100 11.37 epsp 15.33 epsp];                % Structure permittivity array
