...
function par = SL_NRI_n_prism(p_par)
...
d_layers    =   [0.03];             % Thickness of layers (1:N) (m)


% Build structure parameter arrays

eps_struc   =   [air NRI(1) air];     % Structure permittivity array
mu_struc    =   [air NRI(2) air];        % Structure permeabillity array
