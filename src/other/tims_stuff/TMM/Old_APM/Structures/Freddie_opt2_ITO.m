...
function par = Freddie_opt2_ITO(p_par)
...
d_layers    =   [85 60 40 40].*1e-9;             % Thickness of layers (1:N) (m)


% Build structure parameter arrays

eps_struc   =   [75.53 1 11.43 epsp 14.75 epsp];                % Structure permittivity array
mu_struc    =   [1 1 1 1 1 1];                      % Structure permeabillity array
