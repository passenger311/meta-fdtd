#include "CBezierPrism.h"


CBezierPrism::CBezierPrism() {}

CBezierPrism::CBezierPrism(vector<vec2>& pointlist, double height, int steps)
{
...
CObject* CBezierPrism::clone() {
  return new CBezierPrism(m_vBezierPoints, m_dHalfHeight*2.0, m_dSteps);
}
	
void CBezierPrism::preProcess()
{
  m_vPointlist.clear();
