...
--]]
   ...
   BULKSC = function(fh,BULKSC)
	       fh:write(BULKSC.gammap ,"\t! dephasing rate; gammap [1/s] \n")
	       fh:write(BULKSC.M ,"\t! dipole length; M [m]  \n")
	       fh:write(BULKSC.egap ,"\t! bandgap [eV]  \n")
	       fh:write(BULKSC.me ,"\t! effective electron mass; me [m0]\n")
