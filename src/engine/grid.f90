...
!----------------------------------------------------------------------
  ...
  subroutine ReadConfigGrid(funit,lcount,string,sdim)
    ...
    M4_DIM123({
       fdtdreg = CreateBoxRegObj(IBEG, IMAX, 1, JBEG, JEND, 1, KBEG, KEND, 1)
    },{
       fdtdreg = CreateBoxRegObj(IBEG, IMAX, 1, JBEG, JMAX, 1, KBEG, KEND, 1)
    },{
       fdtdreg = CreateBoxRegObj(IBEG, IMAX, 1, JBEG, JMAX, 1, KBEG, KMAX, 1)
    })
