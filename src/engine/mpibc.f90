...
!  module: mpibc / meta
!
!  mpi comms for the E,H fields at partition boundaries.
!
!----------------------------------------------------------------------
...
M4_IFELSE_MPI({
  ...
  integer, dimension(6) :: mpibound=(/ 0,0,0,0,0,0 /)
...
!----------------------------------------------------------------------
  ...
  subroutine ReadConfigMpibc(funit,string)
    ...
    M4_WRITE_DBG({". exit ReadConfigMpibc"})

  end subroutine ReadConfigMpibc
