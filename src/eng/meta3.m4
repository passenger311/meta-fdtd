...
define(`M4_ISOMP', `ifdef(`OMP', `.true.', `.false.')')
...
define(`M4_IFELSE_OMP', `ifdef(`OMP', `$1', `$2')')
define(`M4_IFELSE_CF', `ifdef(`CF', `$1', `$2')')
define(`M4_IFELSE_TE', `ifdef(`TE', `$1', `$2')')
define(`M4_IFELSE_NG', `ifdef(`NG', `$1', `$2')')

define(`M4_ISMPELOG', `ifdef(`MPI', `ifdef(`DBG',`.true.',`')', `.false.')')
define(`M4_IFELSE_MPELOG', `ifdef(`MPI', `ifdef(`DBG',`$1',`')', `$2')')
