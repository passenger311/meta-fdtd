...
--- Absorption FFT inside TFSF
--[[
cfg:DIAG{
   PSPEC{
      file = "fft+xabs",
      time = { 0, ncycles, (ncycles+1)/256 },
      phasewrap = { 1, 0 },
      mode = "S",
   ...
   REG{
      BOX{
         { htfsf-2, htfsf-2, 1, -htfsf+2, htfsf-2, 4, -htfsf+2, htfsf-2, 4 }
      }
   }
}
cfg:DIAG{
   ...
   REG{
      BOX{
         { -htfsf+2, htfsf-2, 4, htfsf-2, htfsf-2, 1, -htfsf+2, htfsf-2, 4 }
      }
   }
}
cfg:DIAG{
   ...
   REG{
      BOX{
         { -htfsf+2, htfsf-2, 4, -htfsf+2, htfsf-2, 4, htfsf-2, htfsf-2, 1 }
      }
   }
}
...
cfg:DIAG{
   ...
   REG{
      BOX{
         { htfsf+2, htfsf+2, 1, -htfsf-2, htfsf+2, 1, -htfsf-2, htfsf+2, 1 }
      }
   }
}
cfg:DIAG{
...
cfg:DIAG{
   ...
   REG{
      BOX{
         { htfsf+1, htfsf+1, 1, -htfsf-2, htfsf+2, 1, -htfsf-2, htfsf+2, 1 }
      }
   }
}
cfg:DIAG{
   ...
   REG{
      BOX{
         { -htfsf-2, htfsf+2, 1, htfsf+1, htfsf+1, 1, -htfsf-2, htfsf+2, 1 }
      }
   }
}
cfg:DIAG{
   ...
   REG{
      BOX{
         { -htfsf-2, htfsf+2, 1, -htfsf-2, htfsf+2, 1, htfsf+1, htfsf+1, 1 }
      }
   }
}
...
cfg:DIAG{
   ...
   REG{
      BOX{
         { -htfsf-3, -htfsf-3, 1, -htfsf-2, htfsf+2, 1, -htfsf-2, htfsf+2, 1 }
      }
   }
}
cfg:DIAG{
   ...
   REG{
      BOX{
         { -htfsf-2, htfsf+2, 1, -htfsf-3, -htfsf-3, 1, -htfsf-2, htfsf+2, 1 }
      }
   }
}
cfg:DIAG{
   ...
   REG{
      BOX{
         { -htfsf-2, htfsf+2, 1, -htfsf-2, htfsf+2, 1, -htfsf-3, -htfsf-3, 1 }
      }
   }
}
