...
real_length_it       = 3.5                 -- 2.5length in taper
real_length_c       = 1.0                 -- 2.0length channel 
real_length_ot      = 1.0                 -- 2.0length out taper
real_length_o2     = 0.5                 -- 0.5length out 2
real_length_o1     = 1.0                 -- 1.0length out 1
real_width_i         = 3.5                 -- width in 
real_width_c        = 0.4                 -- 0.400width channel
real_width_o        = 0.4                 -- width out 
real_width_ii        = 0.180               -- width clad in 
real_width_cc      = 0.260               -- width clad channel/center
real_width_oo      = 0.00                -- 0.2width clad out 0.180
real_width_gi       = 0.05                -- 0.05width sio2 seperation gap input
real_width_go      = 0.05                -- 0.05width sio2 seperation gap output
real_width_gc      = 0.05                -- 0.05width sio2 seperation gap center
...
real_width = math.max(real_width_i+real_width_gi + real_width_ii, real_width_c + real_width_gc + real_width_cc, real_width_o + real_width_go + real_width_oo) + real_width_pad
