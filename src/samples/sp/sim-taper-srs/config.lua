cfg = CONFIG{scenes=false}    -- scences takes either true or false 
...
sc_chi3:add{ BinaryAndNot{ BinaryAndNot{ box_i, box_is1 }, box_is2 }, depth=1, value=1 }
sc_chi3:add{ box_c, depth=1, value=1 }
sc_chi3:add{ BinaryAndNot{ BinaryAndNot{ box_o, box_os1 }, box_os2 }, depth=1, value=1 }
...
sc_eps:add{ box_1, depth=1, value=eps_clad }
sc_eps:add{ box_2, depth=1, value=eps_clad }
...
sc_eps:add{ BinaryAndNot{BinaryAndNot{box_1,box_1b},box_1a}, depth=1, value=eps_clad }
sc_eps:add{ BinaryAndNot{BinaryAndNot{box_2,box_2b},box_2a}, depth=1, value=eps_clad }
...
w = math.max(hwidth_i, hwidth_c, hwidth_o)
...
cfg:CREATE_PREVIEW                  -- create a preview of the scene
{"chi3",                             -- filename: preview_"***".vtk
scene=sc_chi3,                          -- scene to be added
grid=prev_chi3,                     -- grid to be used 
method="default", 
silent=false, 
on=true }

cfg:CREATE_GEO                       -- add the scene to the geometry
{"chi3",                              -- filename: geo_"***".in 
scene=sc_chi3,                           -- scene to be added  
grid=grid_chi3,                       -- grid to be used 
method="default",
comps=3,                             -- number of components of permittivity (or permittivity + permeability) 
silent=false,                        -- silient computation, what will happen if we set true?
on=true }                            -- scene will be updated (true)
...
cfg:SRC{  -- pump
   TFSFINJ{
      invlambda = invwavelength + real_dx * real_invlambdaR,
