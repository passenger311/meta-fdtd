...
pump_on = true
widthl = 5     -- width in number of periods
offsetl = 0    -- offset in number of periods
attackl = 20  -- attack in number of periods
...
probe_on = true
pwidthl = 5     -- width in number of periods
poffsetl = 0    -- offset in number of periods
pattackl = 50 -- attack in number of periods
psustainl = 0   -- sustain in number of periods
pdecayl = 70    -- decay in number of periods    -- decay in number of periods
