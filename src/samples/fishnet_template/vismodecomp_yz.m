function vismodecomp_yz(file,freqnumber,fignum);
...
Ef = reshape(E,floor((facerange(2,2)-facerange(2,1))/facerange(2,3)+1),floor((facerange(3,2)-facerange(3,1))/facerange(3,3)+1),3);
...
surf(z(1:b),y(1:a),E_plot);%sqrt(Ef(2:a,2:b,1).*conj(Ef(2:a,2:b,1))));
