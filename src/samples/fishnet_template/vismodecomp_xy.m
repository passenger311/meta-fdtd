function vismodecomp_xy(file,freqnumber,fignum);
...
Ef = reshape(E,floor((facerange(1,2)-facerange(1,1))/facerange(1,3)+1),floor((facerange(2,2)-facerange(2,1))/facerange(2,3)+1),3);
...
surf(y(1:b),x(1:a),E_plot);%sqrt(Ef(2:a,2:b,1).*conj(Ef(2:a,2:b,1))));
