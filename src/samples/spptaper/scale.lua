...
real_length_i2     = 0.5                 -- length in 2
real_length_it    = 2.0                 -- length in taper
real_length_c    = 2.0                 -- length channel 
real_length_ot    = 2.0                 -- length out taper
real_length_o2    = 0.5                 -- length out 2
real_length_o1    = 1.0                 -- length out 1
real_width_i      = 0.400                 -- width in 
real_width_c      = 0.000                 -- width channel
real_width_o      = 0.400                 -- width out
real_width_g      = 0.05               -- width sio2 seperation gap
real_height_g     = 0.05               -- height sio2 seperation gap
real_width_pad    = 0.5

real_height_wg    = 0.060               -- waveguide height
